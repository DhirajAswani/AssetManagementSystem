    ...
    <body>
        ...
        ?>
               ...
               $db=new Database();
                ...
                $user=new User($conn);
                $result=$user->displayDPORequestsTable();
                ...
                ?>
                          ...
                          ?>
                                            <tr>
                                                ...
                                                <th scope='row'>
                                                    <a href="approveassetsbydpo.php?request_id=<?php echo $result[$i]['request_id'];  ?>&quantity=<?php echo $result[$i]['quantity'];  ?>" class="btn btn-success">Approve</a>
                                                </th>
                                                <th scope='row'>
                                                    <a href="declineassetsbydpo.phprequest_id=<?php echo $result[$i]['request_id'];  ?>&quantity=<?php echo $result[$i]['quantity'];  ?>" class="btn btn-danger">Decline</a>
                                                </th>
