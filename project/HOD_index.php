    ...
    <body>
        ...
        ?>
               ...
               $db=new Database();
                ...
                $user=new User($conn);
                $result=$user->displayHODRequestsTable();
                ...
                ?>
                          ...
                          ?>
                                            <tr>
                                                ...
                                                <th scope='row'>
                                                    <a href="approveassetsbyhod.php?request_id=<?php echo $result[$i]['request_id'];  ?>&quantity=<?php echo $result[$i]['quantity'];  ?>" class="btn btn-success">Approve</a>
                                                </th>
                                                <th scope='row'>
                                                <a href="declinerequest.php?request_id=<?php echo $result[$i]['request_id'];?>&user_type=<?php echo $_SESSION['user_type'];  ?>" class="btn btn-danger">Decline</a>
                                                </th>
